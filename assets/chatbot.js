(function () {
    ...
    function fallback(text) {
        ...
        if (s.includes('companion') && (s.includes('become') || s.includes('apply') || s.includes('join'))) {
            return "You can apply at https://justcompany.priscion.com/companions/. It's an application, not an automatic approval — Just Company reviews your details, verifies your ID, selfie, short video and police certificate, and contacts suitable applicants about next steps.";
        }

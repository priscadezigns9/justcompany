(function () {
    ...
    <div id="jc-chat-window">
        ...
        <div class="jc-qr" id="jc-qr">
            ...
            <button class="jc-qrb" data-q="What verification is required for companions?">Companion verification</button>
    ...
    bubble.addEventListener('click', () => {
        ...
        if (opened && !msgsEl.childElementCount) {
            addMsg('bot', "Hi, I'm the Just Company assistant. Ask me how companionship works, what it costs, how to apply as a companion, or what verification is required.");
        }
    });
    ...
    function fallback(text) {
        ...
        if (s.includes('verification') && (s.includes('companion') || s.includes('video') || s.includes('identity'))) {
            return "Companion applicants provide government ID, a selfie, a short private video for liveness and identity verification, a police character certificate and references. The video is not public and verification does not guarantee a person's character or behaviour.";
        }
        if (s.includes('companion') && (s.includes('become') || s.includes('apply') || s.includes('join'))) {
            return "You can apply at https://justcompany.priscion.com/companions/. It's an application, not an automatic approval — Just Company reviews your details, verifies your ID, selfie, short video and police certificate, and contacts suitable applicants about next steps. If approved, generally within 2–3 business days subject to screening, you are added to the approved Independent Companion list; approval does not guarantee opportunities.";
        }
        ...
        if (s.includes('contact') || s.includes('email') || s.includes('reach')) {
            return "You can reach the team at justcompany@priscion.com, or check https://justcompany.priscion.com/terms.html for full policy details.";
        }
        return "I'm having trouble reaching the assistant right now. In the meantime, you can email justcompany@priscion.com, make an enquiry at https://justcompany.priscion.com/booking/, or check https://justcompany.priscion.com/terms.html.";
    }
})();

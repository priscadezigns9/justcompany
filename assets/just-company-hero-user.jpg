(function () {
    ...
    function fallback(text) {
        ...
        if (s.includes('cost') || s.includes('price') || s.includes('how much') || s.includes('fee')) {
            return "The customer service fee is TT$75 per hour, for one to five hours (so TT$150 for 2 hours, up to TT$375 for 5). That covers the companion's time and coordination — any travel, meals or activity costs are discussed separately. No cash is accepted; payment is by Trinidad bank transfer or PayPal after a companion accepts.";
        }
